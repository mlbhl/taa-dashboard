...
pdf.body(
    "Peer 평균을 출발점으로, SAA가 앵커 역할을 합니다. "
...
pdf.table(
    ...
    [
        ...
        ["비대칭", "O (Damping)", "X"],
        ["SAA 역할", "앵커 (Tilt 방향 판정)", "Base에 직접 반영"],
...
pdf.table(
    ...
    [
        ["주식", "미국", "49.0", "45.5", "47.25", "OW", "+1", "9.45", "+4.73", "47.48"],
        ["주식", "유럽", "10.5", "12.6", "11.55", "N", "0", "2.31", "0", "10.55"],
        ["주식", "일본", "3.5", "3.5", "3.50", "N", "0", "0.70", "0", "3.20"],
        ["주식", "중국", "2.1", "3.5", "2.80", "UW", "-1", "0.56", "-0.28", "2.30"],
        ["주식", "한국", "3.5", "2.1", "2.80", "N", "0", "0.56", "0", "2.56"],
        ["주식", "기타", "1.4", "2.8", "2.10", "N", "0", "0.42", "0", "1.92"],
        ["채권", "미국", "21.0", "18.0", "19.50", "SOW", "+2", "3.90", "+3.90", "21.39"],
        ["채권", "한국", "9.0", "12.0", "10.50", "N", "0", "2.10", "0", "9.60"],
    ],
